...
public class BaseExcelGeneratorFromTemplate {
	...
	//private List<DeploymentRequestTransferOperation> transferOperationList;

	public void initialize_DR(String drName, Shell shell) throws JSchException, IOException{
	...
	public void generateTransferOp(XSSFWorkbook wb){
		...
		List<DeploymentRequestTransferOperation> transferOperationList = 
				this.deploymentRequest.getDeploymentRequestTransferOperation();
